...
- **Zero-code state:** the project is in planning. `make smoke` and `make preflight` will report missing tooling until Vite/TypeScript/Vitest scaffolding is added in Phase 1.
